...
def create_dataframe():
    ...
    # your code here
    # data = {'country': countries, 'gold':gold, 'silver':silver, 'bronze':bronze};
    # olympic_medal_counts_df = pandas.DataFrame(data);

    # or alternatively
    olympic_medal_counts = {'country_name' : Series(countries), 'gold': Series(gold), 'silver': Series(silver), 'bronze': Series(bronze)};
    olympic_medal_counts_df = pandas.DataFrame(olympic_medal_counts);

    return olympic_medal_counts_df


ans = create_dataframe();
print ans;
