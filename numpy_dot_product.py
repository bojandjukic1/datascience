...
def numpy_dot():
    ...
    points_arr = numpy.dot(medal_counts, [4,2,1]);
    olympic_pts = {'country name': countries, 'total pts': points_arr};
    olympic_pts_df = DataFrame(olympic_pts);

    print olympic_pts_df;
